...
Combining cybersecurity expertise with data-driven modeling to uncover patterns and anomalies traditional tools miss, transforming threat detection from reactive defense to predictive intelligence.
...
End-to-end machine learning pipeline for detecting anomalies and threats in system logs.  
...
Focused on deep learning concepts, experiments, and reflections.  
...
Will implement linear or logistic regression in NumPy to understand loss, gradients, and weight updates from first principles.
